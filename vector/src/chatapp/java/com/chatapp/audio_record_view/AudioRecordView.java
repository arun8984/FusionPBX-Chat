package com.chatapp.audio_record_view;
...
public class AudioRecordView {
    ...
    private VectorAutoCompleteTextView editTextMessage;
            ...
            public void onClick(View view) {
                if (layoutAttachment.getVisibility() == View.VISIBLE) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        Animator anim = null;
                        anim = ViewAnimationUtils.createCircularReveal(layoutAttachment, x, y, endRadius, startRadius);
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        Animator anim = null;
                        anim = ViewAnimationUtils.createCircularReveal(layoutAttachment, x, y, startRadius, endRadius);
    ...
    public VectorAutoCompleteTextView getMessageView() {
        ...
        editTextMessage.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().trim().isEmpty()) {
                    ...
                    if (imageViewAttachment.getVisibility() != View.VISIBLE) {
                        imageViewAttachment.setVisibility(View.VISIBLE);
                    ...
                    if (imageViewAttachment.getVisibility() != View.GONE) {
                        ...
                        imageViewAttachment.animate().scaleX(0f).scaleY(0f).setDuration(100).setInterpolator(new LinearInterpolator()).start();
                    }
                }
            }
        });
