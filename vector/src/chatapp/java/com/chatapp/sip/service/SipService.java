...
import com.chatapp.sip.api.MediaState;
...
import com.chatapp.sip.api.SipManager.PresenceStatus;
import com.chatapp.sip.api.SipMessage;
import com.chatapp.sip.api.SipProfile;
import com.chatapp.sip.api.SipProfileState;
import com.chatapp.sip.api.SipUri;
import com.chatapp.sip.db.DBProvider;
import com.chatapp.sip.models.Filter;
import com.chatapp.sip.pjsip.PjSipCalls;
import com.chatapp.sip.pjsip.PjSipService;
import com.chatapp.sip.pjsip.UAStateReceiver;
import com.chatapp.sip.service.receiver.DynamicReceiver4;
import com.chatapp.sip.service.receiver.DynamicReceiver5;
//import com.chatapp.sip.ui.incall.InCallMediaControl;
import com.chatapp.sip.utils.Compatibility;
import com.chatapp.sip.utils.CustomDistribution;
import com.chatapp.sip.utils.ExtraPlugins;
import com.chatapp.sip.utils.ExtraPlugins.DynActivityPlugin;
import com.chatapp.sip.utils.Log;
import com.chatapp.sip.utils.PreferencesProviderWrapper;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.cja.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.cja.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.cja.SipService");
    ...
    public static Intent buildCallUiIntent(Context ctxt, SipCallSession callInfo) {
        ...
        if (toSendInfo.isIncoming()){
			...
			intent.putExtra("CallType","Outbound");
		}
        return intent;
    }
