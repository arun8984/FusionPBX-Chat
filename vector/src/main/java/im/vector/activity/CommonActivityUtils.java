...
import com.chatapp.OtpRequestActivity;
...
public class CommonActivityUtils {
    ...
    public static void logout(final Activity activity, final boolean goToLoginPage) {
        ...
        if (goToLoginPage) {
            ...
            Intent intent = new Intent(context, FusionPBXLoginActivity.class);
        ...
        Matrix.getInstance(context).clearSessions(context, true, new SimpleApiCallback<Void>() {
            ...
            public void onSuccess(Void info) {
                ...
                if (goToLoginPage) {
                    ...
                    // go to login page
                    Intent intent = new Intent(activeContext, FusionPBXLoginActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
